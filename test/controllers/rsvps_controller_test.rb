...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { answer: @rsvp.answer, email: @rsvp.email, message: @rsvp.message, names: @rsvp.names }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { answer: @rsvp.answer, email: @rsvp.email, message: @rsvp.message, names: @rsvp.names }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
